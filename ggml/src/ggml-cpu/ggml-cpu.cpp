...
#error "some routines in ggml.cpp require non-finite math arithmetics -- pass -fno-finite-math-only to the compiler to fix"
...
static void ggml_compute_forward_mul_mat_id(
    ...
    for (int cur_a = 0; cur_a < n_as; ++cur_a) {
        int64_t cne1;// = matrix_row_counts[cur_a];
